...
<head>
  ...
  <title>Mochila do Programador - API</title>
...
<body>
  ...
  <div class="container mt-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mochila - API</li>
      </ol>
    </nav>
  </div>
  ...
  <main class="container py-5">
    <h3 class="text-center section-title">API</h3>
        ...
        <div class="accordion" id="recursosAccordion">
            ...
            <div id="collapseVideos" class="accordion-collapse collapse" aria-labelledby="headingVideos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.youtube.com/watch?v=ghTrp1x_1As" target="_blank">Rocketseat - O que é API?</a></li>
                  <li><a href="https://www.youtube.com/watch?v=f7JWDLFhR_c" target="_blank">Filipe Deschamps - Como Fazer Uma API</a></li>
                  <li><a href="https://www.youtube.com/watch?v=IaJghBTNMzw" target="_blank">Labenu - Postman: tudo o que você precisa saber na prática</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseFerramentas" class="accordion-collapse collapse" aria-labelledby="headingFerramentas" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.alura.com.br/artigos/api?srsltid=AfmBOopvbuX20AXYw4aTbkbFot5qGDyc4HA_dyPIVVTll_DCAhcjTRi4" target="_blank">Alura Artigo - Entenda o que é uma API e sua importância</a></li>
                </ul>
              </div>
            </div>
          </div>
