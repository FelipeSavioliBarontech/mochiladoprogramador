...
<head>
  ...
  <title>Mochila do Programador - Git</title>
...
<body>
  ...
  <div class="container mt-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mochila - Git</li>
      </ol>
    </nav>
  </div>
  ...
  <main class="container py-5">
    <h3 class="text-center section-title">Git / Github</h3>
        ...
        <div class="accordion" id="recursosAccordion">
            ...
            <div id="collapseVideos" class="accordion-collapse collapse" aria-labelledby="headingVideos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://youtu.be/kB5e-gTAl_s?si=xz3LqTdV11VeIDDs" target="_blank">Dev Aprender - Curso de Git e Github Completo 2025</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursos" class="accordion-collapse collapse" aria-labelledby="headingCursos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.cursoemvideo.com/curso/curso-de-git-e-github/" target="_blank">Curso em Vídeo - Git e Github</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseFerramentas" class="accordion-collapse collapse" aria-labelledby="headingFerramentas" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.w3schools.com/git/default.asp" target="_blank">W3Schools - Git</a></li>
                </ul>
              </div>
            </div>
          </div>
