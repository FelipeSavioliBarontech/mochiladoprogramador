...
<head>
  ...
  <title>Mochila do Programador - MySQL</title>
...
<body>
  ...
  <div class="container mt-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mochila - MySQL</li>
      </ol>
    </nav>
  </div>
  ...
  <main class="container py-5">
    <h3 class="text-center section-title">MySQL</h3>
        ...
        <div class="accordion" id="recursosAccordion">
            ...
            <div id="collapseVideos" class="accordion-collapse collapse" aria-labelledby="headingVideos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://youtu.be/G7bMwefn8RQ?si=f-zpj4JtDuWEAiB0" target="_blank">Dev Aprender - Curso SQL Completo 2025</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursos" class="accordion-collapse collapse" aria-labelledby="headingCursos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.cursoemvideo.com/curso/mysql/" target="_blank">Curso em Vídeo - MySQL</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursosPagos" class="accordion-collapse collapse" aria-labelledby="headingCursosPagos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.alura.com.br/formacao-consultas-mysql" target="_blank">Alura - MySQL</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseFerramentas" class="accordion-collapse collapse" aria-labelledby="headingFerramentas" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.w3schools.com/sql/default.asp" target="_blank">W3Schools - MySQL</a></li>
                  <li><a href="https://dev.mysql.com/doc/">Documentação MySQL</a></li>
                </ul>
              </div>
            </div>
          </div>
