...
<head>
  ...
  <title>Mochila do Programador - HTML</title>
...
<body>
  ...
  <div class="container mt-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mochila - HTML</li>
      </ol>
    </nav>
  </div>
  ...
  <main class="container py-5">
    <h2 class="text-center section-title">Recursos Úteis</h2>
    <div class="row justify-content-center">
      <div class="col-12 col-md-10 col-lg-8">
        ...
        <div class="accordion" id="recursosAccordion">
            ...
            <div id="collapseVideos" class="accordion-collapse collapse" aria-labelledby="headingVideos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.youtube.com/@CursoemVideo" target="_blank">Curso em Vídeo</a></li>
                  <li><a href="https://www.youtube.com/@FilipeDeschamps" target="_blank">Filipe Deschamps</a></li>
                  <li><a href="https://www.youtube.com/@DevAprender" target="_blank">Dev Aprender</a></li>
                  <li><a href="https://www.youtube.com/@Rocketseat" target="_blank">Rocketseat</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <!-- Artigos -->
          <div class="accordion-item mb-4">
            <h2 class="accordion-header" id="headingArtigos">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseArtigos" aria-expanded="false" aria-controls="collapseArtigos">
                <i class="bi bi-journal-code"></i> Artigos e Tutoriais
              </button>
            </h2>
            <div id="collapseArtigos" class="accordion-collapse collapse" aria-labelledby="headingArtigos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://dev.to/" target="_blank">Dev.to</a></li>
                  <li><a href="https://medium.com/tag/programação" target="_blank">Medium - Programação</a></li>
                  <li><a href="https://www.freecodecamp.org/news/" target="_blank">FreeCodeCamp News</a></li>
            ...
            <div id="collapseFerramentas" class="accordion-collapse collapse" aria-labelledby="headingFerramentas" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  ...
                  <li><a href="https://github.com/trending" target="_blank">GitHub Trending</a></li>
                </ul>
              </div>
            </div>
          </div>
