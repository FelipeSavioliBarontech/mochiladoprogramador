...
<head>
  ...
  <title>Mochila do Programador - JS</title>
...
<body>
  ...
  <div class="container mt-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mochila - JS</li>
      </ol>
    </nav>
  </div>
  ...
  <main class="container py-5">
    <h3 class="text-center section-title">Javascript</h3>
        ...
        <div class="accordion" id="recursosAccordion">
            ...
            <div id="collapseVideos" class="accordion-collapse collapse" aria-labelledby="headingVideos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.youtube.com/watch?v=YqSfq1LiGvw" target="_blank">Bonieky Lacerda - Aprenda Javascript em 1 video (+ projeto prático)</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursos" class="accordion-collapse collapse" aria-labelledby="headingCursos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.cursoemvideo.com/curso/javascript/" target="_blank">Curso em Vídeo - HTML5 & CSS3</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursosPagos" class="accordion-collapse collapse" aria-labelledby="headingCursosPagos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.alura.com.br/cursos-online-front-end/javascript?srsltid=AfmBOoo0V8fsnnWOXK_gv9CF-VihKhM67qvMC3KbAtUqrJ8yVZb0j2Xa" target="_blank">Alura - JAVASCRIPT</a></li>
                </ul>
              </div>
            </div>
          </div>
