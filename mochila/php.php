...
<head>
  ...
  <title>Mochila do Programador - PHP</title>
...
<body>
  ...
  <div class="container mt-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mochila - PHP</li>
      </ol>
    </nav>
  </div>
  ...
  <main class="container py-5">
    <h3 class="text-center section-title">PHP</h3>
        ...
        <div class="accordion" id="recursosAccordion">
            ...
            <div id="collapseVideos" class="accordion-collapse collapse" aria-labelledby="headingVideos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.youtube.com/watch?v=O73xbQvGhHk&list=PL0N5TAOhX5E9eJ9Ix6YUIgEw3lNmaIEE9&index=1" target="_blank">Unset - Curso de PHP 8</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursos" class="accordion-collapse collapse" aria-labelledby="headingCursos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.cursoemvideo.com/curso/php-basico/" target="_blank">Curso em Vídeo - PHP</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseCursosPagos" class="accordion-collapse collapse" aria-labelledby="headingCursosPagos" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.alura.com.br/formacao-php-web?utm_term=&utm_campaign=%5BSearch%5D+%5BPerformance%5D+%5BCursos%5D+DSA+-+Forma%C3%A7%C3%B5es&utm_source=google&utm_medium=cpc&campaign_id=21045490451_158851964763_691754664154&utm_id=21045490451_158851964763_691754664154&hsa_acc=7964138385&hsa_cam=%5BSearch%5D+%5BPerformance%5D+%5BCursos%5D+DSA+-+Forma%C3%A7%C3%B5es&hsa_grp=158851964763&hsa_ad=691754664154&hsa_src=g&hsa_tgt=dsa-2276348409543&hsa_kw=&hsa_mt=&hsa_net=google&hsa_ver=3&gad_source=1&gad_campaignid=21045490451&gbraid=0AAAAADpqZIBwAHWx8itGRk4CaRoZadAK0&gclid=Cj0KCQjw0Y3HBhCxARIsAN7931XQVnj7N_HVShoq0PYJToENe1tJDOe_6UI1Eyx4DGNW2lQShC-XCXUaAp8dEALw_wcB" target="_blank">Alura - PHP</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="collapseFerramentas" class="accordion-collapse collapse" aria-labelledby="headingFerramentas" data-bs-parent="#recursosAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled mb-0">
                  <li><a href="https://www.w3schools.com/php/default.asp" target="_blank">W3Schools - Javascript</a></li>
